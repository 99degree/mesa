...
/*
 * imapper4_getservice_stub.cpp
 * Satisfy link-time dependency on IMapper::getService(...) without HIDL.
 * Returns nullptr and does not talk to binder.
 */
...
namespace android::hardware::graphics::mapper::V4_0 {

// Static method definition to satisfy the linker.
::android::sp<IMapper> IMapper::getService(const std::string& /*serviceName*/,
                                           bool /*getStub*/) {
    return nullptr;
}
